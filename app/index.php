<?php 
    ...
    function showLoginForm() {
        ?>
            <form id="login-form" action="loginSubmit" method="get">
                <fieldset>
                    <legend>Account Data</legend>
                    
                    <div class="login-form">	
                        <label for="login-user">User or e-mail:</label><br>
                            <input type="text" id="login-user" name="userName" autocomplete="username" require><br>
                        <label for="login-pass">Password:</label><br>
                            <input type="password" id="login-pass" name="userPassword" autocomplete="current-password" require> <br>				
                    </div>
                </fieldset>
